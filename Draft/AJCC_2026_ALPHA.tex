...
\variation{\Large 1... Rxb5 2. Qxb5#}\\
\variation{\Large 1... Rxc6+ 2. Rxc6#}\\
\variation{\Large 1... Rb7+ 2. Rxb7#}\\

\variation{\Large 1. Qa1} fails as \variation{\Large 1. ... Rxb5 2. Nb3+ Ra5 3. Rxa5#/Qxa5#}\\
...
\newpage
\textbf{\Large Q5. What is the missing piece? Which turns? What is the position of the missing piece? Then, answer the last few moves.}\\
...
\newpage
\textbf{\Large Q6. WHO moved last? WHICH piece was moved from WHERE to WHERE?}\\
{\setchessboard{boardfontsize=30pt, labelfontsize=14pt, showmover=false}
\newchessgame
...
\newpage
\textbf{\Large Q7. The position below occured after the Black's 4th move from the starting position. Answer the moves to reach this position.}\\
{\setchessboard{boardfontsize=30pt,labelfontsize=14pt}
\newchessgame
\chessboard[setfen=rnbqkbnr/pp3ppp/2p1p3/8/4P3/8/PPPP1PPP/RNBQK1NR]}\\

\textbf{\Large Answer:}\\
This type of chess problem is called "Proof game", a type of retrograde analysis. This position is easily reached by \variation{1. e4 e6 2. Bb5 c6 3. Bxc6 dxc6}. However, this problem is asking the same position after Black's 4th move. There should be illogical, but legal White and Black move. The answer is\\
\variation{1. e4 e6}.\\
\variation{2. Bb5+ Ke7}.\\
\variation{3. Bxd7 c6}.\\
...
\newpage
\textbf{\Large Q8. The position below occured after the Black's 4th move from the starting position. Answer the moves to reach this position.}\\
{\setchessboard{boardfontsize=30pt,labelfontsize=14pt}
\newchessgame
...
\newpage
\textbf{\Large Q9. Helpmate in 1. What is Black's move to make "Mate in 1"? Answer Black's move, then White's mate move.}\\
{\setchessboard{boardfontsize=30pt,labelfontsize=14pt}
\newchessgame
...
\newpage
\textbf{\Large 10. Helpmate in 1. White's positions are all same as the previous question.}\\
\textbf{\Large Q10A.}
{\setchessboard{boardfontsize=20pt,labelfontsize=12pt}
\newchessgame
...
\variation{2. Nc8+ Ka8??}\\
\variation{3. Bd5#}\\
With Black's help, Knight and Bishop endgame is quite easy.

\vfill{\Large Source: Hilmar Ebert, Schach-Echo, 1977 (YACDB: 638060)}


\newpage
\textbf{\Large Q12. Selfmate in 2. White forces Black to mate White King himSELF in Black's 2nd move.}\\
{\setchessboard{boardfontsize=30pt,labelfontsize=14pt}
\newchessgame
...
\newpage
\textbf{\Large Q13. Selfmate in 2. White forces Black to mate White King himSELF in a given moves.}\\
{\setchessboard{boardfontsize=30pt,labelfontsize=14pt}
\newchessgame
...
\newpage
\textbf{\Large Q14. White to play. Who wins?}\\
{\setchessboard{boardfontsize=30pt,labelfontsize=14pt}
\newchessgame
\chessboard}\\
\textbf{\Large Answer:}\\
