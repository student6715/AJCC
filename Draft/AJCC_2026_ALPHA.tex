...
\textbf{\Large Answer:}\\
\variation{1. Qd3+ Rc4 2. Qxc4+ Ka5 3. Qb5#} takes 3 moves. The right answer starts with a Queen sacrifice, \variation{1. Qa5+ Rxa5 2. Nb4#}. If Black King takes the White Queen, \variation{1... Kxa5 2.Ra7#}.\\

\textbf{\Large It is very important that you can only get full marks when you find the checkmate within the required moves (in this question, 2 moves, not 3 moves.)}\\
...
\newpage
\textbf{\Large Q5. What is the missing piece? Whose turn is it? Which square does the missing piece belong on? Show the previous moves that reached this position.}\\
...
3. What was the previous White's move? It is not with the White's Bishop, so the White King moved from b3 to c3, which creates a discovered check to the Black King.
4.
...
\newpage
\textbf{\Large Q7. The position below occured after the Black's 4th move, from the starting position. Show the moves to reach this position.}\\
{\setchessboard{boardfontsize=30pt,labelfontsize=14pt}
\newchessgame
...
\newpage
\textbf{\Large Q8. The position below occured after the Black's 4th move, from the starting position. Show the moves to reach this position.}\\
{\setchessboard{boardfontsize=30pt,labelfontsize=14pt}
\newchessgame
...
\newpage
\textbf{\Large Q9. Helpmate in 1. What is Black's move to allow White a  "Mate in 1"? Answer Black move's first, then White's checkmates.}\\
{\setchessboard{boardfontsize=30pt,labelfontsize=14pt}
\newchessgame
...
\newpage
\textbf{\Large 10. Helpmate in 1. White's positions are all same as the previous question. Black's position is different in all questions}\\
\textbf{\Large Q10A.}
{\setchessboard{boardfontsize=20pt,labelfontsize=12pt}
\newchessgame
...
\newpage
\textbf{\Large Q11. Helpmate in 3. (Black moves 1st and White checkmates with their 3rd move)}\\
{\setchessboard{boardfontsize=30pt,labelfontsize=14pt}
\newchessgame
...
\newpage
\textbf{\Large Q12. Selfmate in 2. White forces Black to checkmate White's King with Black's 2nd move. (NB This must be a forced variation as Black will try and avoid checkmating White if possible!)}\\
{\setchessboard{boardfontsize=30pt,labelfontsize=14pt}
\newchessgame
...
\newpage
\textbf{\Large Q13. Selfmate in 2. White forces Black to checkmate White in 2 moves.}\\
{\setchessboard{boardfontsize=30pt,labelfontsize=14pt}
\newchessgame
