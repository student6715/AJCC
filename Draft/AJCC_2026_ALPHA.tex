...
\newpage
\textbf{\Large Q5. Mate in 2. (4 marks)}\\
{\setchessboard{boardfontsize=30pt,labelfontsize=14pt}
\newchessgame
...
\variation{1. O-O  Kh3}\\
\variation{2. Rf3#}\\
Please remember that, unless otherwise stated, castling and en passant should be considered in chess problems.

\vfill{\Large Source: W. E. Candy, 1911 (YACPDB: 3889)}


\newpage
\textbf{\Large Q6. What is the missing piece? Whose turn is it? Which square does the missing piece belong on? Show the previous moves that reached this position.}\\
...
4. The White king on b3 is under double attack. The only possible moves are a White pawn move from c2 to c4 to prevent the bishop's check, followed by an en passant of a Black pawn from b4 to c3. Then, the White king takes the Black pawn on c3.\\

\textbf{\Large -1. Kb3-Kxc3+}\\
\textbf{\Large -2. b4-c3 e.p.}\\
\textbf{\Large -3. c2-c4}\\
\textbf{\Large -4. *-Bd5+} (* means any legal positions)\\

What happend is as below.
{\setchessboard{boardfontsize=20pt,labelfontsize=12pt}
\newchessgame
...
\newpage
\textbf{\Large Q7. WHO moved last? WHICH piece was moved from WHERE to WHERE?}\\
{\setchessboard{boardfontsize=30pt, labelfontsize=14pt, showmover=false}
\newchessgame
...
\newpage
\textbf{\Large Q9. The position below occured after the Black's 4th move, from the starting position. Show the moves to reach this position.}\\
{\setchessboard{boardfontsize=30pt,labelfontsize=14pt}
\newchessgame
...
\newpage
\textbf{\Large Q10. Helpmate in 1. What is Black's move to allow White a  "Mate in 1"? Answer Black move's first, then White's checkmates.}\\
{\setchessboard{boardfontsize=30pt,labelfontsize=14pt}
\newchessgame
...
\newpage
\textbf{\Large 11. Helpmate in 1. White's positions are all same as the previous question. Black's position is different in all questions}\\
\textbf{\Large Q11A.}
{\setchessboard{boardfontsize=20pt,labelfontsize=12pt}
\newchessgame
...
\newpage
\textbf{\Large Q12. Helpmate in 3. (Black moves 1st and White checkmates with their 3rd move)}\\
{\setchessboard{boardfontsize=30pt,labelfontsize=14pt}
\newchessgame
...
\newpage
\textbf{\Large Q13. Selfmate in 2. White forces Black to checkmate White's King with Black's 2nd move. (NB This must be a forced variation as Black will try and avoid checkmating White if possible!)}\\
{\setchessboard{boardfontsize=30pt,labelfontsize=14pt}
\newchessgame
...
\newpage
\textbf{\Large Q14. Selfmate in 2. White forces Black to checkmate White in 2 moves.}\\
{\setchessboard{boardfontsize=30pt,labelfontsize=14pt}
\newchessgame
