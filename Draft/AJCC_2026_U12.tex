...
\Large{
\variation{1. Ka6!} (Counterintuitive, but making a space for the rook)\\
\variation{1... h4}\\
\variation{2. Ka5 h3}\\
\variation{3. Ka4 Ka1}\\
...
\\
\Large{
Some of representative solutions are below.
}
...
Five queens lie on a main diagonal in the middle solution and on a sub-diagonal in the right solution, respectively.\\
